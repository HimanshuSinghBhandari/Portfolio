   ...
   const onClickNext = () => {
    ...
    return(
        <section id="home" className="relative overflow-hidden">
            ...
            <motion.div className="flex flex-col items-center mt-2 lg:mt-10"
            ...
            >
                <span className="text-xl text-center font-light tracking-wide sm:text-3xl lg:text-5xl">
                    ...
                    onInit={(typewriter) => {
                        typewriter
                         .pauseFor(1000)
                         .typeString("Himanshu Dedicated to your services")
                         .pauseFor(500)
                         .deleteAll(100)
                         .pauseFor(1500)
                         .typeString(
                            `Frontend developer <br><span style="font-weight:600;"}>Himanshu Singh</span>`
                         )
                         .start();
                    }}
                    options={{
